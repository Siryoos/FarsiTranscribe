...
class PersianTextNormalizer:
    ...
    def normalize_text(self, text: str) -> str:
        ...
        try:
            ...
            if self.config.normalize_persian_numbers:
                normalized_text = self._normalize_persian_numbers(
                    normalized_text
                )
    ...
    def _normalize_persian_numbers(self, text: str) -> str:
        ...
        for (
            persian_num,
            english_num,
        ) in self.persian_to_english_numbers.items():
    ...
    def create_normalization_report(
        ...
        report = {
            ...
            "success_rate": (
                len(output_texts) / len(input_texts) if input_texts else 0
            ),
            "text_length_stats": {},
    ...
    def get_text_statistics(self, text: str) -> Dict:
        ...
        stats = {
            ...
            "has_persian_numbers": any(
                char in self.persian_to_english_numbers for char in text
            ),
            "has_arabic_chars": any(
                char in self.arabic_to_persian for char in text
            ),
        }
