...
class PyannoteDiarizer:
    ...
    def _init_pipeline(self):
        ...
        try:
            ...
            self.logger.info(f"Loading pyannote diarization model: {model_name}")
    ...
    def diarize_audio(
        ...
        try:
            ...
            try:
                ...
                self.logger.info(f"Diarization complete. Found {len(set(s.speaker_id for s in segments))} speakers")
                return segments
