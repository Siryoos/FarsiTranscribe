...
class PersianTextPostProcessor:
    ...
    def post_process_text(self, text: str, metadata: Optional[Dict[str, Any]] = None) -> Tuple[str, Dict[str, Any]]:
        """
        ...
        if self.normalizer:
            ...
            processing_metadata['processing_steps'].append('persian_normalization')
        ...
        processing_metadata['corrections_made']['repetitions_removed'] = repetition_count
        ...
        self.logger.info(f"Post-processing completed. Final length: {len(text)}")
    ...
    def _remove_repetitions(self, text: str) -> Tuple[str, int]:
        ...
        text = re.sub(self.persian_patterns['repeated_chars'], replace_repetitions, text)
    ...
    def batch_process(self, texts: List[str]) -> List[Tuple[str, Dict[str, Any]]]:
